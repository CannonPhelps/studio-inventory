			...
			<div class="flex items-center mb-3">
				...
				<div class="flex space-x-1 flex-shrink-0">
					{#if user.role === 'admin'}
						<button
							onclick={goToAdmin}
							class="text-secondary hover:text-primary hover:bg-tertiary rounded-lg p-2 transition-all duration-200 focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-sidebar focus:outline-none"
